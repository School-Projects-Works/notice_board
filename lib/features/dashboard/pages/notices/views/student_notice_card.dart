...
class StudentsNoticeCard extends ConsumerStatefulWidget {
  const StudentsNoticeCard({super.key, required this.notice});
  final NoticeModel notice;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _StudentsNoticeCardState();
}

class _StudentsNoticeCardState extends ConsumerState<StudentsNoticeCard> {
bool isHover = false;
