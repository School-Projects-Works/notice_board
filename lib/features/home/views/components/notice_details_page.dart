...
import 'package:notice_board/core/functions/int_to_date.dart';
...
class NoticeDetailsPage extends ConsumerStatefulWidget {
  const NoticeDetailsPage({super.key, required this.noticeId});
  final String noticeId;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _NoticeDetailsPageState();
}

class _NoticeDetailsPageState extends ConsumerState<NoticeDetailsPage> {
